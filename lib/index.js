...
exports.default = function (_ref) {
  ...
  function getWrappedFunctionReturnWithTypeCheck(node, typeParameters) {
    ...
    return [t.variableDeclaration('const', [t.variableDeclarator(id, t.callExpression(t.memberExpression(f, t.identifier('call')), [t.identifier('this')].concat(callParams)))]), assertAST, t.returnStatement(id)];
  }
  ...
  function getExternalImportDeclaration(path) {
    ...
    return [importNode].concat(node.specifiers.map(function (specifier) {
      return t.variableDeclaration('const', [t.variableDeclarator(specifier.local, t.logicalExpression('||', t.memberExpression(typesId, specifier.imported), getAnyType()))]);
    }));
  }
  ...
  function findTypeAnnotationInObjectPattern(name, objectPattern, objectTypeAnnotation) {
    ...
    try {
      var _loop = function _loop() {
        ...
        var typeAnnotation = (0, _lodash2.default)(objectTypeAnnotation.properties, function (propType) {
